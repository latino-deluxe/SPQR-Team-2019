...
while(True):
    clock.tick()
    tt_yellow = [(0,999,999,1)]     ## creo una lista di tuple per il giallo, valore x = 999 : non trovata
    tt_blue = [(0,999,999,2)]       ## creo una lista di tuple per il blue, valore x = 999 : non trovata
