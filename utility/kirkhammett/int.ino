void gest()   //utilizzato in semifinale
{
  ...
  float tolleranza = 5.0;                          //PRIMA ERA 10 OCCHIO
 ...
 attesa=0;
  ...
  switch (sens)
  {
    case 0b000001:            // sensori singoli 1
      ...
      if ((ball_sensor > 14) || (ball_sensor < 6))   // vede la palla in avanti
      {
        si = 1;
        sf = 4;
      }
      else  // vede la palla dietro
      {
        EXT_LINEA = 0;
        si = 10;
        sf = 13;
    ...
    case 0b000010:            // sensori singoli 2
      si = 4;
      sf = 7;
      if ((us_dx < 35) && (us_dx > 25)) //sto vicino al bordo destro
      {
        EXT_LINEA = 270;
        status_x = EST;
      }
      else // inverto il moto
      {
    ...
    case 0b010000:            // sensori singoli 5
      si = 13;
      sf = 16;
      if ((us_sx < 35) && (us_sx > 25)) //sto vicino al bordo sinistro
      {
        EXT_LINEA = 90;
        status_x = OVEST;
      }
    ...
    if ((us_fr <= 40) && (us_sx <= 40))  EXT_LINEA = 135;
    if ((us_fr <= 40) && (us_dx <= 40))  EXT_LINEA = 225;

    if ((us_px <= 40) && (us_dx <= 40))  EXT_LINEA = 330;
    if ((us_px <= 40) && (us_sx <= 40))  EXT_LINEA = 30;

    if ((status_x == EST) && (status_y == NORD)) EXT_LINEA = 203;
    if ((status_x == OVEST) && (status_y == NORD)) EXT_LINEA = 135;

    if ((status_x == EST) && (status_y == SUD)) EXT_LINEA = 330;
    if ((status_x == OVEST) && (status_y == SUD)) EXT_LINEA = 30;

    if ((status_x == EST) && (status_y == CENTRO)) EXT_LINEA = 270;
    if ((status_x == OVEST) && (status_y == CENTRO)) EXT_LINEA = 90;

    if ((us_sx >= 17) && (us_sx <= 35)) EXT_LINEA = 90;
    if ((us_dx >= 17) && (us_dx <= 35)) EXT_LINEA = 270;
