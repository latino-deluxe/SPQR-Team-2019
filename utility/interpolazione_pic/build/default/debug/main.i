...
# 36 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\usart_custom.h" 3
...
void readSensors_old() {
    ...
    angle = atan2f(vect[0],vect[1]);
    angle = (angle * 4068) / 71;
    dist = sqrtf((vect[0] * vect[0]) + (vect[1] * vect[1]));
